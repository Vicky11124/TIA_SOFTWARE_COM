...
VALUES 
  (
    ...
    '149.99',
    '199.99',
    ARRAY['Logo Design (2-3 concepts)', 'Business Card Design', 'Basic Brand Identity', '2 Rounds of Revisions', 'Social Media Graphics', 'Standard Turnaround Time'],
    false,
    true,
    0,
  ...
  (
    ...
    '699.99',
    '899.99',
    ARRAY['Everything in the Pro Plan', 'UX/UI Design for Apps & Websites', 'Virtual Assistance', 'Dedicated Account Manager'],
    false,
    true,
    3,
    '2026-03-31T08:41:19.93321+00:00',
